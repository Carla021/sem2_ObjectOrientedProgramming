...
#ifndef A6_CARLA021_1_CSVREPOSITORY_H
#define A6_CARLA021_1_CSVREPOSITORY_H
...
public:
    CSVRepository(const std::vector<Event>& list_of_events, const std::string& user_filename);
...
#endif //A6_CARLA021_1_CSVREPOSITORY_H
